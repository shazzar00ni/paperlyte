...
describe('Monitoring Utilities', () => {
  ...
  describe('addBreadcrumb', () => {
    it('should handle breadcrumb addition', () => {
      expect(() =>
        monitoring.addBreadcrumb('User clicked save button', 'user')
      ).not.toThrow()
    })
    ...
    it('should handle breadcrumbs with data', () => {
      ...
      expect(() =>
        monitoring.addBreadcrumb('Note operation', 'data', data)
      ).not.toThrow()
    })
  ...
  describe('setUser', () => {
    it('should handle user context setting', () => {
      expect(() =>
        monitoring.setUser('user-123', 'test@example.com', { plan: 'free' })
      ).not.toThrow()
    })
