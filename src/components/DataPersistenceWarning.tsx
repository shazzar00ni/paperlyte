...
const DataPersistenceWarning: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const dismissed = localStorage.getItem('paperlyte_warning_dismissed') === 'true'
      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-yellow-700 mb-2">
            Your notes are currently stored locally on this device. For full data persistence and cross-device sync, 
            please wait for our API integration in Q4 2025.
          </p>
          <button
