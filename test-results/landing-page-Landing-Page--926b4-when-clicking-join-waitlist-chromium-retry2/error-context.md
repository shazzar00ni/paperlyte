...
- generic [ref=e4]:
        ...
        - generic [ref=e7]:
            ...
            - generic [ref=e11]:
                - link "Start Writing Now" [ref=e12] [cursor=pointer]:
                    - /url: /editor
                - button "Join Waitlist" [active] [ref=e13] [cursor=pointer]
    ...
    - generic [ref=e17]:
        ...
        - generic [ref=e21]:
            ...
            - generic [ref=e30]:
                - generic [ref=e31]:
                    - img "Search functionality with tags and filtering options" [ref=e32]
                    - button "Previous slide" [ref=e33] [cursor=pointer]:
                        - img [ref=e34] [cursor=pointer]
                    - button "Next slide" [ref=e36] [cursor=pointer]:
                        - img [ref=e37] [cursor=pointer]
                - generic [ref=e39]:
                    - heading "Smart Search & Tags" [level=4] [ref=e40]
                    - paragraph [ref=e41]: Find your notes instantly with intelligent search and flexible tagging system.
            - generic [ref=e43]:
    ...
    - generic [ref=e99]:
        - generic [ref=e100]:
            - heading "Join the Waitlist" [level=2] [ref=e101]
            - button "Close modal" [ref=e102] [cursor=pointer]:
                - img [ref=e103] [cursor=pointer]
        - generic [ref=e106]:
            - paragraph [ref=e107]: Be among the first to experience lightning-fast note-taking. Get early access and exclusive updates.
            - generic [ref=e108]:
            ...
            - generic [ref=e122]:
                - generic [ref=e123]: I'm interested as a...
                - generic [ref=e124]:
                    - img [ref=e125]
                    - combobox "I'm interested as a..." [ref=e128]:
                        - option "Student"
                        - option "Professional" [selected]
                        - option "Creative"
                        - option "Other"
            - button "Join Waitlist" [ref=e129] [cursor=pointer]
            - paragraph [ref=e130]: We respect your privacy. No spam, just launch updates.
```
