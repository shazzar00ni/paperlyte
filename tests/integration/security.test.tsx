...
describe('Security Integration Tests', () => {
  ...
  describe('XSS Prevention', () => {
    ...
    it('should allow safe HTML elements', async () => {
      ...
      const safeContent = '<p><strong>Bold text</strong> and <em>italic text</em></p>'
    ...
    it('should remove dangerous style attributes', async () => {
      ...
      const dangerousStyle = '<p style="background: url(javascript:alert(\'XSS\'))">Text</p>'
    ...
    it('should not expose sensitive information in error messages', async () => {
      ...
      try {
        ...
        const onChange = vi.fn().mockImplementation(() => {
          throw new Error('Database connection failed: admin:password@localhost:5432/secret_db')
        })
